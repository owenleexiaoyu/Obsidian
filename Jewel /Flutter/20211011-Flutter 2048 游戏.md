...
Panel 部分我定义成了一个叫做 Game2048Panel 的 Widget，继承自 StatefulWidget，因为内部有是否游戏结束等状态。UI 部分，当游戏结束时，我们使用 Stack 布局，蒙层盖在棋盘的上方，游戏没有结束时，只有棋盘。棋盘可以识别用户上下左右的手势，所以需要 GestureDetector 组件

![panel-ui](https://gitee.com/owenlee233/image_store/raw/master/202110241646540.png)
