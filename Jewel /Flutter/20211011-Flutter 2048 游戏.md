...
![1635178599499311](https://gitee.com/owenlee233/image_store/raw/master/202110260019670.gif)
...
这步完成后，其实 2048 的主体功能就完成了，我们已经可以开始不断滑动来合并数字块。演示效果如下：



#### 更新分数

当有两个块合并时，我们需要更新当前的分数，在当前分数上加上合并后的数值。因为这个分数的数字并不是显示在 Game2048Panel 里面，而是显示在 Game2048Page 的 Header 部分，所以我们需要通过一种方式将最新的分数传递给 Game2048Page，这里我们使用一个回调：
